...
source ../sdk_lib.bash || ( echo "ERROR! SDK library could not be sourced to install SDK." && exit )
get_commandline_tools

source ../emulator_manager_lib.bash || ( echo "ERROR! Emulator manager library could not be sourced." && exit )
